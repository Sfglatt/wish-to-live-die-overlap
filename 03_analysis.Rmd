...
# Look at descriptives
describe(Baseline_data[, c("WTL_unique_abs", "WTD_unique_abs", "Unique_combined_abs", "WTL_WTD_shared_abs")])
...
jmv::ttestPS(
  ...
  pairs = list(
    ...
    list(i1 = "Unique_combined_abs", i2 = "WTL_WTD_shared_abs") # unique WTL + unique WTD vs overlap
  ),
  wilcoxon = TRUE,
  norm = TRUE,
  meanDiff = TRUE,
